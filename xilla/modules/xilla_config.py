...
class _InlineFormDraft:
    ...
    def __init__(self):
        ...
        self.reply_markup: XillaReplyMarkup | None = None
...
@loader.tds
class XillaConfigMod(loader.Module):
    """Interactive configurator for Xilla Userbot"""

    strings = {"name": "XillaConfig"}
    ...
    def _category_option(
        ...
        if option in XillaConfigMod._config_categories(instance).get(category, []):
            return option
