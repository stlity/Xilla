        ...
        self.config = loader.ModuleConfig(
            loader.ConfigValue(
                ...
                (
                    ...
                    " Xilla will try to determine, which client caused logs. E.g. there"
                    ...
                    " Xilla will send all logs to Client1 and Client2, even if it is"
    ...
    async def logs(
        ...
        other = (
            *main.__version__,
            (
                " <a"
                f' href="https://github.com/stlity/Xilla/commit/{ghash}">@{ghash[:8]}</a>'
                if ghash
                else ""
            ),
        )
