...
class CoreMod(loader.Module):
    ...
    @loader.command(
        ...
        en_doc="Information of Xilla",
        ua_doc="Інформація про Хероку",
        de_doc="Informationen über Xilla",
    )
    async def xillacmd(self, message: Message):
        ...
        await utils.answer(
            message,
            self.strings["xilla"].format(
                (
                    utils.get_platform_emoji()
                    if self._client.xilla_me.premium
                    else "🏔️ <b>Xilla userbot</b>"
                ),
                *version.__version__,
            ...
            + (branch_text),
            file="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/xilla/xilla_cmd.png",
    ...
    async def togglecmdcmd(self, message: Message):
        ...
        if cmd.lower() not in [c.lower() for c in mod_inst.xilla_commands.keys()]:
    ...
    async def installationcmd(self, message: Message):
        ...
        if (
            ...
            await self.inline.form(
                ...
                photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/xilla/xilla_installation.png",
            )
        ):

            await self.client.send_file(
                message.peer_id,
                "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/xilla/xilla_installation.png",
