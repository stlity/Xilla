...
class Presets(loader.Module):
    """Suggests new Xilla users a packs of modules to load"""
    ...
    async def _menu(self):
        await self.inline.bot.send_photo(
            self._client.tg_id,
            "https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/xilla/presets_cmd.png",
    ...
    async def presets(self, message: Message):
        ...
        await self.inline.form(
            message=message,
            photo="https://raw.githubusercontent.com/coddrago/assets/refs/heads/main/xilla/presets_cmd.png",
